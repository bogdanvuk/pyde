...
from PyQt5.QtGui import QPalette, QColor, QFocusEvent
...
class QsciScintillaCompat(QsciScintilla):
    ...
    def __init__(self, parent=None):
        ...
        self.__indicators_cnt = QsciScintilla.INDIC_CONTAINER
    ...
    def indicatorDefine(self, style, color=None):
        """
        ...
        """
        if self.__indicators_cnt > QsciScintilla.INDIC_MAX:
            raise ValueError("indicator number out of range")
        
        indicator = self.__indicators_cnt
        self.__indicators_cnt += 1
    ...
    def setIndicatorRange(self, indicator, spos, length, value=0):
        """
