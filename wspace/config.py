...
def reload_config_for_win(win: Dependency('win')):
    ...
    ddic['actions/switch_view'](win.child_by_name('http://www.analog.com/en/products/digital-to-analog-converters/da-converters/ad9144.html#product-samplebuy'), [0, 0, 0])
    ddic['actions/switch_view'](win.child_by_name('and.vhd'), [0, 0, 1])
