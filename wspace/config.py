...
#     ddic['win'].widget.adjustSize()
    win.layout.split([], Qt.Vertical, (5,1))
    ddic['actions/switch_view'](ddic['view/actions.py'], [0])
#     ddic['win'].layout.place(ddic['view/actions.py'], [0])
    ddic['view/actions.py'].widget.pos = 0
    ddic['view/actions.py'].widget.anchor = 0
#     ddic['win'].layout.place(ddic['view/interpret'], [1])
    ...
    ddic['view/actions.py'].set_focus()
